...
function Oe(t) {
    ...
    return !c && m && i.touch && v.indexOf(`${o}x${a}`) >= 0 && (c = r.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), m = !1), d && !u && (l.os = "android", l.android = !0), (c || p || f) && (l.os = "ios", l.ios = !0), l
}

function ze(t) {
    return t === void 0 && (t = {}), K || (K = Oe(t)), K
}
let U;
            ...
            !e || e.destroyed || !e.initialized || (r = new ResizeObserver(f => {
                l = n.requestAnimationFrame(() => {
                    ...
                    f.forEach(y => {
                        ...
                        S && S !== e.el || (m = E ? E.width : (g[0] || g).inlineSize, v = E ? E.height : (g[0] || g).blockSize)
                    }), (m !== p || v !== u) && o()
                })
            }), r.observe(e.el))
        },
...
function Ne() {
    ...
    typeof S == "string" && S.indexOf("%") >= 0 ? S = parseFloat(S.replace("%", "")) / 100 * r : typeof S == "string" && (S = parseFloat(S)), t.virtualSize = -S, c.forEach(w => {
        l ? w.style.marginLeft = "" : w.style.marginRight = "", w.style.marginBottom = "", w.style.marginTop = ""
    }), i.centeredSlides && i.cssMode && (H(s, "--swiper-centered-offset-before", ""), H(s, "--swiper-centered-offset-after", ""));
    ...
    for (let w = 0; w < f; w += 1) {
        C = 0;
        let T;
        if (c[w] && (T = c[w]), M && t.grid.updateSlide(w, T, c), !(c[w] && F(T, "display") === "none")) {
            if (i.slidesPerView === "auto") {
                A && (c[w].style[t.getDirectionLabel("width")] = "");
                const P = getComputedStyle(T),
                    b = T.style.transform,
                    z = T.style.webkitTransform;
                if (b && (T.style.transform = "none"), z && (T.style.webkitTransform = "none"), i.roundLengths) C = t.isHorizontal() ? oe(T, "width", !0) : oe(T, "height", !0);
                else {
                    const L = e(P, "width"),
                        O = e(P, "padding-left"),
                        N = e(P, "padding-right"),
                ...
                b && (T.style.transform = b), z && (T.style.webkitTransform = z), i.roundLengths && (C = Math.floor(C))
            } else C = (r - (i.slidesPerView - 1) * S) / i.slidesPerView, i.roundLengths && (C = Math.floor(C)), c[w] && (c[w].style[t.getDirectionLabel("width")] = `${C}px`);
            c[w] && (c[w].swiperSlideSize = C), m.push(C), i.centeredSlides ? (h = h + C / 2 + x / 2 + S, x === 0 && w !== 0 && (h = h - r / 2 - S), w === 0 && (h = h - r / 2 - S), Math.abs(h) < 1 / 1e3 && (h = 0), i.roundLengths && (h = Math.floor(h)), I % i.slidesPerGroup === 0 && p.push(h), u.push(h)) : (i.roundLengths && (h = Math.floor(h)), (I - Math.min(t.params.slidesPerGroupSkip, I)) % t.params.slidesPerGroup === 0 && p.push(h), u.push(h), h = h + C + S), t.virtualSize += C + S, x = C, I += 1
        }
    }
    if (t.virtualSize = Math.max(t.virtualSize, r) + y, l && o && (i.effect === "slide" || i.effect === "coverflow") && (s.style.width = `${t.virtualSize+S}px`), i.setWrapperSize && (s.style[t.getDirectionLabel("width")] = `${t.virtualSize+S}px`), M && t.grid.updateWrapperSize(C, p), !i.centeredSlides) {
        const w = [];
        for (let T = 0; T < p.length; T += 1) {
            let P = p[T];
            i.roundLengths && (P = Math.floor(P)), p[T] <= t.virtualSize - r && w.push(P)
        }
    ...
    if (a && i.loop) {
        ...
        if (i.slidesPerGroup > 1) {
            ...
            for (let b = 0; b < T; b += 1) p.push(p[p.length - 1] + P)
        }
        for (let T = 0; T < t.virtual.slidesBefore + t.virtual.slidesAfter; T += 1) i.slidesPerGroup === 1 && p.push(p[p.length - 1] + w), u.push(u[u.length - 1] + w), t.virtualSize += w
    }
    ...
    if (Object.assign(t, {
        ...
        H(s, "--swiper-centered-offset-before", `${-p[0]}px`), H(s, "--swiper-centered-offset-after", `${t.size/2-m[m.length-1]/2}px`);
        const w = -t.snapGrid[0],
            T = -t.slidesGrid[0];
        t.snapGrid = t.snapGrid.map(P => P + w), t.slidesGrid = t.slidesGrid.map(P => P + T)
    }
    if (f !== d && t.emit("slidesLengthChange"), p.length !== g && (t.params.watchOverflow && t.checkOverflow(), t.emit("snapGridLengthChange")), u.length !== E && t.emit("slidesGridLengthChange"), i.watchSlidesProgress && t.updateSlidesOffset(), t.emit("slidesUpdated"), !a && !i.cssMode && (i.effect === "slide" || i.effect === "fade")) {
...
function Re(t) {
    ...
    for (let a = 0; a < s.length; a += 1) {
        ...
        (u >= 0 && u < e.size - 1 || m > 1 && m <= e.size || u <= 0 && m >= e.size) && (e.visibleSlides.push(d), e.visibleSlidesIndexes.push(a), s[a].classList.add(i.slideVisibleClass)), v && s[a].classList.add(i.slideFullyVisibleClass), d.progress = n ? -f : f, d.originalProgress = n ? -p : p
    }
}
...
function He() {
    ...
    else l ? (a = e.filter(f => f.column === n)[0], c = e.filter(f => f.column === n + 1)[0], d = e.filter(f => f.column === n - 1)[0]) : a = e[n];
    a && (a.classList.add(i.slideActiveClass), l ? (c && c.classList.add(i.slideNextClass), d && d.classList.add(i.slidePrevClass)) : (c = Ie(a, `.${i.slideClass}, swiper-slide`)[0], i.loop && !c && (c = e[0]), c && c.classList.add(i.slideNextClass), d = Pe(a, `.${i.slideClass}, swiper-slide`)[0], i.loop && !d === 0 && (d = e[e.length - 1]), d && d.classList.add(i.slidePrevClass))), t.emitSlidesClasses()
}
const W = (t, e) => {
    ...
    ie = t => {
        ...
        if (t.params.rewind || t.params.loop)
            for (let l = n - e; l <= r + e; l += 1) {
                ...
                for (let l = Math.max(n - e, 0); l <= Math.min(r + e, i - 1); l += 1) l !== n && (l > r || l < n) && J(t, l)
    };
...
function je(t) {
    ...
    if (typeof a > "u" && (a = We(e)), s.indexOf(i) >= 0) d = s.indexOf(i);
    else {
...
function rt(t, e, i, s, n) {
    ...
    if (r.initialized && l !== f && (!r.allowSlideNext && (p ? g > r.translate && g > r.minTranslate() : g < r.translate && g < r.minTranslate()) || !r.allowSlidePrev && g > r.translate && g > r.maxTranslate() && (f || 0) !== l)) return !1;
    l !== (c || 0) && i && r.emit("beforeSlideChangeStart"), r.updateProgress(g);
    let E;
    if (l > f ? E = "next" : l < f ? E = "prev" : E = "reset", p && -g === r.translate || !p && g === r.translate) return r.updateActiveIndex(l), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), o.effect !== "slide" && r.setTranslate(g), E !== "reset" && (r.transitionStart(i, E), r.transitionEnd(i, E)), !1;
    if (o.cssMode) {
        ...
        if (e === 0) {
            ...
            })) : u[S ? "scrollLeft" : "scrollTop"] = h, x && requestAnimationFrame(() => {
    ...
    return r.setTransition(e), r.setTranslate(g), r.updateActiveIndex(l), r.updateSlidesClasses(), r.emit("beforeTransitionStart", e, s), r.transitionStart(i, E), e === 0 ? r.transitionEnd(i, E) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function(h) {
        !r || r.destroyed || h.target === this && (r.wrapperEl.removeEventListener("transitionend", r.onSlideToWrapperTransitionEnd), r.onSlideToWrapperTransitionEnd = null, delete r.onSlideToWrapperTransitionEnd, r.transitionEnd(i, E))
...
function ct() {
    ...
    if (e.loop) {
        ...
        r = parseInt(t.clickedSlide.getAttribute("data-swiper-slide-index"), 10), e.centeredSlides ? n < t.loopedSlides - s / 2 || n > t.slides.length - t.loopedSlides + s / 2 ? (t.loopFix(), n = t.getSlideIndex(V(i, `${l}[data-swiper-slide-index="${r}"]`)[0]), ee(() => {
            t.slideTo(n)
        })) : t.slideTo(n) : n > t.slides.length - s ? (t.loopFix(), n = t.getSlideIndex(V(i, `${l}[data-swiper-slide-index="${r}"]`)[0]), ee(() => {
            t.slideTo(n)
        })) : t.slideTo(n)
    } else t.slideTo(n)
}
...
function ut(t) {
    ...
    if (o) {
        ...
        } else q("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
        n()
    } else if (a) {
        if (i.loopAddBlankSlides) {
            const c = i.grid.rows - e.slides.length % i.grid.rows;
            d(c), e.recalcSlides(), e.updateSlides()
        } else q("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
        n()
    } else n();
    e.loopFix({
        slideRealIndex: t,
...
function pt(t) {
    ...
    if (a.allowSlidePrev = !0, a.allowSlideNext = !0, a.virtual && u.virtual.enabled) {
        i && (!u.centeredSlides && a.snapIndex === 0 ? a.slideTo(a.virtual.slides.length, 0, !1, !0) : u.centeredSlides && a.snapIndex < u.slidesPerView ? a.slideTo(a.virtual.slides.length + a.snapIndex, 0, !1, !0) : a.snapIndex === a.snapGrid.length - 1 && a.slideTo(a.virtual.slidesBefore, 0, !1, !0)), a.allowSlidePrev = c, a.allowSlideNext = f, a.emit("loopFix");
        return
    }
    ...
    let g = y;
    g % y !== 0 && (g += y - g % y), g += u.loopAdditionalSlides, a.loopedSlides = g;
    ...
    if (P < g) {
        ...
        for (let b = 0; b < g - P; b += 1) {
            ...
            if (E) {
                const L = w - z - 1;
                for (let O = d.length - 1; O >= 0; O -= 1) d[O].column === L && S.push(O)
            } else S.push(w - z - 1)
        }
    } else if (P + v > w - g) {
    ...
    if (a.__preventObserver__ = !0, requestAnimationFrame(() => {
            ...
            d[b].swiperLoopMoveDOM = !0, p.prepend(d[b]), d[b].swiperLoopMoveDOM = !1
        }), I && h.forEach(b => {
            d[b].swiperLoopMoveDOM = !0, p.append(d[b]), d[b].swiperLoopMoveDOM = !1
        }), a.recalcSlides(), u.slidesPerView === "auto" ? a.updateSlides() : E && (S.length > 0 && M || h.length > 0 && I) && a.slides.forEach((b, z) => {
        ...
        if (S.length > 0 && M) {
            if (typeof e > "u") {
                ...
                o ? a.setTranslate(a.translate - L) : (a.slideTo(x + C, 0, !1, !0), n && (a.touchEventsData.startTranslate = a.touchEventsData.startTranslate - L, a.touchEventsData.currentTranslate = a.touchEventsData.currentTranslate - L))
            } else if (n) {
            ...
            if (typeof e > "u") {
                ...
                o ? a.setTranslate(a.translate - L) : (a.slideTo(x - A, 0, !1, !0), n && (a.touchEventsData.startTranslate = a.touchEventsData.startTranslate - L, a.touchEventsData.currentTranslate = a.touchEventsData.currentTranslate - L))
            } else {
...
function Tt(t) {
    ...
    Object.assign(n, {
        ...
        isScrolling: void 0,
        startMoving: void 0
    }), l.startX = u, l.startY = m, n.touchStartTime = j(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1);
    let v = !0;
...
function xt(t) {
    ...
    let d;
    if (a.type === "touchmove") {
        if (d = [...a.changedTouches].filter(I => I.identifier === s.touchId)[0], !d || d.identifier !== s.touchId) return
    } else d = a;
    if (!s.isTouched) {
    ...
    if (typeof s.isScrolling > "u") {
        let I;
        i.isHorizontal() && r.currentY === r.startY || i.isVertical() && r.currentX === r.startX ? s.isScrolling = !1 : p * p + u * u >= 25 && (I = Math.atan2(Math.abs(u), Math.abs(p)) * 180 / Math.PI, s.isScrolling = i.isHorizontal() ? I > n.touchAngle : 90 - I > n.touchAngle)
    }
    ...
    let S;
    if (new Date().getTime(), s.isMoved && s.allowThresholdMove && y !== i.touchesDirection && g && E && Math.abs(m) >= 1) {
        Object.assign(r, {
            startX: c,
            startY: f,
            currentX: c,
    ...
    let h = !0,
        x = n.resistanceRatio;
    if (n.touchReleaseOnEdges && (x = 0), m > 0 ? (g && E && !S && s.allowThresholdMove && s.currentTranslate > (n.centeredSlides ? i.minTranslate() - i.slidesSizesGrid[i.activeIndex + 1] : i.minTranslate()) && i.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }), s.currentTranslate > i.minTranslate() && (h = !1, n.resistance && (s.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + s.startTranslate + m) ** x))) : m < 0 && (g && E && !S && s.allowThresholdMove && s.currentTranslate < (n.centeredSlides ? i.maxTranslate() + i.slidesSizesGrid[i.slidesSizesGrid.length - 1] : i.maxTranslate()) && i.loopFix({
            direction: "next",
            setTranslate: !0,
            activeSlideIndex: i.slides.length - (n.slidesPerView === "auto" ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10)))
        }), s.currentTranslate < i.maxTranslate() && (h = !1, n.resistance && (s.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - s.startTranslate - m) ** x))), h && (a.preventedByNestedSwiper = !0), !i.allowSlideNext && i.swipeDirection === "next" && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && i.swipeDirection === "prev" && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && !i.allowSlideNext && (s.currentTranslate = s.startTranslate), n.threshold > 0)
...
function yt(t) {
    ...
    if (s.type === "touchend" || s.type === "touchcancel") {
        if (n = [...s.changedTouches].filter(x => x.identifier === i.touchId)[0], !n || n.identifier !== i.touchId) return
    } else {
    ...
    if (e.allowClick) {
        ...
        e.updateClickedSlide(x && x[0] || s.target, x), e.emit("tap click", s), p < 300 && f - i.lastClickTime < 300 && e.emit("doubleTap doubleClick", s)
    }
    if (i.lastClickTime = j(), ee(() => {
    ...
    i.isTouched = !1, i.isMoved = !1, i.startMoving = !1;
    let u;
    if (l.followFinger ? u = a ? e.translate : -e.translate : u = -i.currentTranslate, l.cssMode) return;
    ...
    for (let x = 0; x < d.length; x += x < l.slidesPerGroupSkip ? 1 : l.slidesPerGroup) {
        ...
        typeof d[x + I] < "u" ? (m || u >= d[x] && u < d[x + I]) && (v = x, y = d[x + I] - d[x]) : (m || u >= d[x]) && (v = x, y = d[d.length - 1] - d[d.length - 2])
    }
    let g = null,
        E = null;
    ...
    if (p > l.longSwipesMs) {
        ...
        e.swipeDirection === "next" && (S >= l.longSwipesRatio ? e.slideTo(l.rewind && e.isEnd ? g : v + h) : e.slideTo(v)), e.swipeDirection === "prev" && (S > 1 - l.longSwipesRatio ? e.slideTo(v + h) : E !== null && S < 0 && Math.abs(S) > l.longSwipesRatio ? e.slideTo(E) : e.slideTo(v))
    } else {
        if (!l.shortSwipes) {
            e.slideTo(e.activeIndex);
            return
        }
        e.navigation && (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl) ? s.target === e.navigation.nextEl ? e.slideTo(v + h) : e.slideTo(v) : (e.swipeDirection === "next" && e.slideTo(g !== null ? g : v + h), e.swipeDirection === "prev" && e.slideTo(E !== null ? E : v))
    }
}
...
const ve = (t, e) => {
    ...
    i[a]("touchstart", t.onDocumentTouchStart, {
        ...
        passive: !0
    }), (s.preventClicks || s.preventClicksPropagation) && n[a]("click", t.onClick, !0), s.cssMode && r[a]("scroll", t.onScroll), s.updateOnWindowResize ? t[d](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", ce, !0) : t[d]("observerUpdate", ce, !0), n[a]("load", t.onLoad, {
        capture: !0
    })
};
...
function It() {
    ...
    t.onTouchStart = Tt.bind(t), t.onTouchMove = xt.bind(t), t.onTouchEnd = yt.bind(t), t.onDocumentTouchStart = Pt.bind(t), e.cssMode && (t.onScroll = Et.bind(t)), t.onClick = bt.bind(t), t.onLoad = Mt.bind(t), ve(t, "on")
}
...
function Ot() {
    ...
    }), f && !v ? t.disable() : !f && v && t.enable(), t.currentBreakpoint = l, t.emit("_beforeBreakpoint", a), i && (u ? (t.loopDestroy(), t.loopCreate(e), t.updateSlides()) : !m && y ? (t.loopCreate(e), t.updateSlides()) : m && !y && t.loopDestroy()), t.emit("breakpoint", a)
}
...
class D {
    constructor() {
        ...
        const o = this;
        o.__swiper__ = !0, o.support = he(), o.device = ze({
            userAgent: i.userAgent
        }), o.browser = Ge(), o.eventsListeners = {}, o.eventsAnyListeners = [], o.modules = [...o.__modules__], i.modules && Array.isArray(i.modules) && o.modules.push(...i.modules);
        const a = {};
        o.modules.forEach(c => {
            c({
                params: i,
        ...
        const d = G({}, ue, a);
        return o.params = G({}, d, Z, i), o.originalParams = G({}, o.params), o.passedParams = G({}, i), o.params && o.params.on && Object.keys(o.params.on).forEach(c => {
    ...
    getSlideIndex(e) {
        const {
            slidesEl: i,
            params: s
        } = this, n = V(i, `.${s.slideClass}, swiper-slide`), r = le(n[0]);
        return le(e) - r
    }
    ...
    slidesPerViewDynamic(e, i) {
        ...
        if (n.centeredSlides) {
            let f = r[d] ? r[d].swiperSlideSize : 0,
                p;
            for (let u = d + 1; u < r.length; u += 1) r[u] && !p && (f += r[u].swiperSlideSize, c += 1, f > a && (p = !0));
            for (let u = d - 1; u >= 0; u -= 1) r[u] && !p && (f += r[u].swiperSlideSize, c += 1, f > a && (p = !0))
        } else if (e === "current")
            for (let f = d + 1; f < r.length; f += 1)(i ? l[f] + o[f] - l[d] < a : l[f] - l[d] < a) && (c += 1);
        else
    ...
    mount(e) {
        ...
        return !l && i.params.createElements && (l = te("div", i.params.wrapperClass), s.append(l), V(s, `.${i.params.slideClass}`).forEach(o => {
            l.append(o)
        })), Object.assign(i, {
            el: s,
            wrapperEl: l,
    ...
    init(e) {
        ...
        }), ie(i), i.initialized = !0, ie(i), i.emit("init"), i.emit("afterInit"), i
    }
    destroy(e, i) {
...
function Rt({
    ...
    const {
        activeIndex: n
    } = t, r = l => l.parentElement ? l.parentElement : t.slides.filter(a => a.shadowRoot && a.shadowRoot === l.parentNode)[0];
...
function $t({
    ...
    const s = () => {
            const {
                ...
                cssMode: f,
                centeredSlides: p
            } = o, u = p ? .5 : Math.min(Math.max(o.materialEffect.slideSplitRatio, 0), 1), m = p ? .5 : 1 - Math.min(Math.max(o.materialEffect.slideSplitRatio, 0), 1);
            for (let v = 0; v < r.length; v += 1) {
                ...
                if (h <= 0)
                    if (p && d > 1) {
                        if (h <= 0 && h >= -(d - 2) && (C = I, M = 1, A = 1), b && h < -(d - Math.ceil(d / 2))) {
                            const L = Math.ceil(d / 2) - Math.abs(h);
                            M = L, A = M ** 4, C = I + w * (1 - L) * (1 + T * 2)
                        }
                        if (z && h < -(d / 2 - 1) && h >= -(d / 2)) {
                            const L = d / 2 - Math.abs(h);
                            M = u - T + (m + T * 2) * (d / 2 - Math.abs(h)), A = ((M - u) / (1 - u)) ** 4, C = I + w * (m + T) * (1 - L)
                        }
                        if (z && h < -d / 2) {
                            let L = d / 2 + 1 - Math.abs(h);
                            M = 0, L >= 0 && (L = -T * 2 + L * (1 + T * 2), L = Math.max(Math.min(L, 1), 0), M = (m - T) * L), C = I + w * (m + T) * (2 - L) + w * (m - T) * (1 - L)
                        }
                    } else M = 1 + h, C = -x, A = M ** 4;
                if (d === 1) h > 0 && (M = 1 - h, C = -x + a * Math.min(h, 1), A = M ** 4);
                else {
                    if (h > 0 && h <= d - 2 && (C = I, M = 1, A = 1), z ? h > d / 2 - 1 && h <= d / 2 : h > d - 2 && h <= d - 1) {
                        const O = z ? Math.floor(d / 2) : 1;
                        M = u - T + (m + T * 2) * (d - O - Math.abs(h)), C = I, u === 1 ? A = M ** 4 : A = ((M - u) / (1 - u)) ** 4
                    }
                    if (b && h > d - Math.ceil(d / 2)) {
                        const O = Math.ceil(d / 2) - (d - Math.abs(h));
                        C = I - w * (T * 2) * O, M = 1 - O, A = M ** 4
                    }
                    if (h > d - 1 && h <= d && !p) {
                        const O = d - Math.abs(h),
                            N = u - T,
                            _ = m - T;
                        M = _ + (N - _) * O, C = I - w * (m + T) * (1 - O), m === 0 && (A = M ** 4)
                    }
                    if (h > (p ? d / 2 : d) && !b) {
                        let O = (p ? d / 2 + 1 : d + 1) - Math.abs(h),
                            N = 0;
                        M = 0, O >= 0 && (O = -T * 2 + O * (1 + T * 2), O = Math.max(Math.min(O, 1), 0), M = (m - T) * O, N = -O * (m + T) * w + O * c), C = -x + a * Math.min(h, 1) + N, A = 0
                    }
                }
                M < 0 && (M = 0), M > 1 && (M = 1), y.style.setProperty("--swiper-material-scale", M), E.forEach(L => {
                    L.style.opacity = A
                }), S.forEach(L => {
                    let O = parseFloat(L.getAttribute("data-swiper-material-scale"));
                    (Number.isNaN(O) || !O && O !== 0) && (O = 1), L.style.transform = `scale(${1+(O-1)*(1-M)})`
                }), t.isHorizontal() ? (g.style.width = `${100*M}%`, g.style.transform = `translate3d(${C-P}px, 0, 0)`) : (g.style.height = `${100*M}%`, g.style.transform = `translate3d(0, ${C-P}px, 0)`)
            }
        },
        n = r => {
            const {
    ...
    e("beforeInit", () => {
        ...
        t.classNames.push(`${t.params.containerModifierClass}material`), t.isElement && t.hostEl && t.hostEl.classList.add(`swiper-${t.params.direction}`);
        const r = {
