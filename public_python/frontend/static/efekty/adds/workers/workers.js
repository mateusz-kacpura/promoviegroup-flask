...
var swiper = new Swiper(".swiper", {
  ...
  slidesPerView: 1, // Ilość slajdów widocznych jednocześnie
  spaceBetween: 20, // Odstęp między slajdami
  loop: true, // Zapętlenie karuzeli
  autoplay: {
      delay: 5000, // Opóźnienie automatycznego przewijania (w milisekundach)
      disableOnInteraction: false, // Czy przewijanie automatyczne powinno być wyłączone po interakcji użytkownika
  },
  scrollbar: {
    el: ".swiper-scrollbar",
    draggable: true,
